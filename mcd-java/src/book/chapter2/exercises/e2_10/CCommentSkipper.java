...
public class CCommentSkipper {
    private Reader reader;
    private int chint;
    
    public CCommentSkipper(Reader reader) throws IOException {
        this.reader = reader;
        skipChar();
    }
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        CCommentSkipper commentSkipper = new CCommentSkipper(new FileReader(args[0]));
